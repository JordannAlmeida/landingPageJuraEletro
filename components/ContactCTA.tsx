...
export default function ContactCTA() {
    return (
        <section id="contact" className="py-24 bg-green-900 relative overflow-hidden">
            {/* Decorative Circles */}
            <div className="absolute top-0 left-0 w-64 h-64 bg-green-800 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-emerald-900 rounded-full blur-3xl translate-x-1/3 translate-y-1/3"></div>
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    >
                        ...
                        Estamos prontos para transformar a energia do seu imóvel em <strong>Pimenta e toda a região</strong>.
                    </motion.p>
                    ...
                    >
                        <motion.a
                            ...
                            className="bg-yellow-500 hover:bg-yellow-400 text-green-900 font-bold py-4 px-10 rounded-2xl transition shadow-xl hover:shadow-yellow-500/20 flex items-center justify-center gap-3 text-lg"
                        >
